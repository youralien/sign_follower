In the first iteration, the u-turn image and right-turn image matched correctly with the templates, but not the left turn image, for the left turn image, all three templates had a confidence of 0. 
